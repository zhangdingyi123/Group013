...
<body>
    <div class="form-page">
        ...
        <p class="links"><a href="${pageContext.request.contextPath}/admin/register.jsp">没有账号？注册</a> &nbsp;|&nbsp; <a href="${pageContext.request.contextPath}/">返回首页</a></p>
    </div>
</body>
</html>
