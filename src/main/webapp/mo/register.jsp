...
<head>
    ...
    <title><%= I18n.msg(request, "reg.mo.title") %> - <%= I18n.msg(request, "common.sysName") %></title>
    ...
    <main class="auth-shell">
        ...
        <form method="post" action="${pageContext.request.contextPath}/mo/auth">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" required placeholder="<%= I18n.msg(request, "reg.mo.ph.name") %>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label><%= I18n.msg(request, "auth.label.dept") %></label>
                <input type="text" name="department" placeholder="<%= I18n.msg(request, "reg.mo.ph.dept") %>">
            </div>
            <div class="form-group">
        ...
        <p class="links"><a href="${pageContext.request.contextPath}/mo/auth"><%= I18n.msg(request, "auth.link.hasAccount") %></a><span class="dot">·</span><a href="${pageContext.request.contextPath}/"><%= I18n.msg(request, "auth.link.home") %></a></p>
        </div>
    </main>
