    ...
    <div class="form-page">
        ...
        <form method="post" action="${pageContext.request.contextPath}/mo/auth">
            ...
            <div class="form-group">
                <label>姓名 *</label>
                <input type="text" name="name" required placeholder="李老师">
            </div>
            <div class="form-group">
                <label>邮箱 *</label>
            ...
            <div class="form-group">
                <label>院系/课程组</label>
                <input type="text" name="department" placeholder="可选">
            </div>
            <div class="form-group">
                <label>密码 *</label>
        ...
        <p class="links"><a href="${pageContext.request.contextPath}/mo/auth">已有账号？登录</a> &nbsp;|&nbsp; <a href="${pageContext.request.contextPath}/">返回首页</a></p>
    </div>
</body>
</html>
