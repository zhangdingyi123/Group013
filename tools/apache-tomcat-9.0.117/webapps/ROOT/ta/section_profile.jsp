...
<div id="pc-overview" class="pc-profile-stack">
    ...
    <section id="pc-quick" class="pc-card" aria-label="<%= I18n.msg(request, "pc.quick.title") %>">
        ...
        <div class="pc-card-bd pc-quick-wrap">
            ...
            <a href="<%= ctx %>/ta/dashboard?tab=jobs&favorites=1" class="pc-tile">
                <span class="pc-tile-ic" aria-hidden="true">⭐</span>
                <span class="pc-tile-t"><%= I18n.msg(request, "pc.tile.favorites") %></span>
                <span class="pc-tile-d"><%= I18n.msg(request, "pc.tile.favorites.d", request.getAttribute("favoriteJobsCount") != null ? request.getAttribute("favoriteJobsCount") : 0) %></span>
            </a>
